...
#공 크기에 따른 최초 속도 설정
ball_speed_y =[-18, -15, -12, -9]   #ball_images 의 index 0,1,2,3 에 해당함 / 마이너스로 해야 위로 줄어드는 속도로 반영되므로
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3:
                    ...
                    #왼쪽으로 튕겨나가는 1단계 작은공
                    balls.append({
                        "pos_x" : ball_x_pos + ball_width/2 -(small_ball_width/2),                   #공의 x 좌표
                        "pos_y" : ball_y_pos + ball_height/2 -(small_ball_height/2),                   #공의 y 좌표
